...
public class Menu {
	public static void menu() {
		...
		while (cont) {
			...
			System.out.println("####################################################################################");
			System.out.println("########### Press 1 to Established Connection ######################################");
			System.out.println("########### Press 2 to Read Database Files #########################################");
			System.out.println("########### Press 3 to Create Necessary Tables #####################################");
			System.out.println("########### Press 4 to Import Files to Designated Database #########################");
			System.out.println("########### Press 5 to Display Movies by Year and Genre ############################");
			System.out.println("########### Press 6 to Start a Search by Genre Between Specified Years #############");
			System.out.println("########### Press 7 to Display Highest and Lowest Ratings for an Actor/Actress #####");
			System.out.println("########### Press 8 to Display an Actor/Actress's Known for Titles #################");
			System.out.println("########### Press 0 to Exit From Application #######################################");
			System.out.println("####################################################################################");
			...
			case 2:
				System.out.println("Would you like to see the datas on the console?");
			...
			case 4:
				System.out.println("Please wait while process continues... It may take a while");

				TableCreation.createTable(TableStrings.moviesCsvImport);
				System.out.println("moies.csv has been imported to the movies table of the database");

				TableCreation.createTable(TableStrings.ratingsCsvImport);
				System.out.println("rating.csv has been imported to the rating table of the database");
				...
				System.out.println("There are two files waiting to upload but it may longer. Plaese wait....");

				TableCreation.createTable(TableStrings.moviesTsvImport);
				System.out.println("movies.tsv has been imported to the moviescsv table of the database");

				TableCreation.createTable(TableStrings.namesTsvImport);
				System.out.println("names.tsv has been imported to the links table of the database");
				break;
